...
@interface ShopCollectViewController ()<UITableViewDelegate, UITableViewDataSource>
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.priceLab removeFromSuperview];
    [cell.btn setTitle:@"进 店" forState:UIControlStateNormal];
